...
const { getAllProducts, postProduct, updateProduct, deleteProduct, createCategory, getProductAndReviews, createProductTag, removeTag, updateProductTag, getProductByTag } = require('../controllers/products');
